...
paru -S alacritty android-tools bat bemenu exa fd firefox firewalld gnome-themes-extra gvfs-mtp imv libnotify mako mpc mpd mpv ncmpcpp nemo nemo-fileroller neofetch nano noto-fonts noto-fonts-emoji pacman-contrib pavucontrol polkit-gnome qt5-wayland reflector skim starship sway swaybg swayidle telegram-desktop ttf-firacode-nerd ttf-font-awesome ttf-iosevka-nerd ttf-jetbrains-mono-nerd waybar xdg-user-dirs zathura zsh zsh-autosuggestions zsh-syntax-highlighting xdg-desktop-portal kvantum qt5ct python-i3ipc
